...
public class StandardUserCreateServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (userName == null || userName.trim().isEmpty()) {
	        ...
	        try {
	        	...
	        	StandardUser standardUser = new StandardUser(userName, email, dob, "", true, address, true);
	        	standardUser = standardUserDao.create(standardUser);
	        	
	        	messages.put("success", "Successfully created " + userName + "; userId: " + standardUser.getUserId());
